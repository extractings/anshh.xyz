...
import profile from "../../public/chai.jpg";
    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        ...
        <div className="flex gap-10 text-[#e4ded7] sm:gap-12 md:gap-14 lg:gap-14">
          <Link
          href="https://github.com/AnshhCodeZ"
            target="_blank"
          ...
          <Link
            href="https://www.instagram.com/anshh.ily?igsh=MXUwN2tkazZqcGQ5Mg=="
            target="_blank"
          ...
          <Link
            href="https://x.com/Anshhxyz?t=tSfViH1CTlsZfppWtKmKhQ&s=09"
            target="_blank"
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            Hey there, i'm Ansh. I'm, a Ui Ux Designer .
          </p>
        </motion.div>
